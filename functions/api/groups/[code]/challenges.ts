...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  // Only allow adding challenges during suggesting phase
  ...
  // Verify target participant exists in this group
  ...
  // Can't suggest challenges for yourself
  ...
  // Use authenticated userId as the suggester (not from body)
